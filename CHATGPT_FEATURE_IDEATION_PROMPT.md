# ChatGPT Feature Ideation Prompt
...
3. **Ideate Features:** Propose new features that align with stag/hen party use cases, considering:
   ...
   - **During-event features** (real-time engagement, activities, social interaction)
...
*(Features that enhance the actual stag/hen week experience - e.g., Mr/Mrs Quiz, live activities)*
...
Below is the comprehensive analysis of the Stag App web application. Review this thoroughly to understand the current state, architecture, features, and technical constraints before ideating new features.
...
- This is a BETA MVP - focus on features that enhance the core value proposition
- Tech stack: Next.js 14, Supabase (PostgreSQL), Resend (email), Vercel (hosting)
- Current focus: Payment management, event info, email notifications
- Admin panel is tabbed (Event Info, Attendees, Payments, Bookings, Email Templates)
- Authentication via Supabase (email/password + magic links)
- Row Level Security (RLS) enabled on all tables
- Mobile-responsive design already in place
- Custom domain: `owens-stag.com`
...
Now, analyze the provided context document and provide comprehensive feature ideation following the format above.
